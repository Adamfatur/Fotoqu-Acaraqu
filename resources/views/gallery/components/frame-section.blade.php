        ...
        <div class="p-8">
            ...
            <div class="flex flex-col lg:grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div class="lg:col-span-1 w-full">
                    <div class="relative group frame-container w-full max-w-sm lg:max-w-full mx-auto">
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-600 rounded-2xl blur opacity-25 group-hover:opacity-50 transition-opacity">
                        </div>
                        <div class="relative bg-white p-3 rounded-2xl shadow-xl">
                            <img src="{{ $frame->preview_url ?? asset('images/frame-placeholder.png') }}"
                                ...
                                title="Premium Photo Frame {{ $photoSession->session_code }}" loading="eager"
                ...
                <div class="lg:col-span-1 space-y-6 w-full">
                    <div class="text-center lg:text-left">
                        <div
                            class="inline-flex items-center gap-2 bg-green-50 text-green-700 px-3 py-1 rounded-full text-sm font-medium mb-4">
                            <i class="fas fa-check-circle"></i>
                            <span>Siap Download</span>
                        </div>
                        <h3 class="text-xl lg:text-2xl font-bold text-gray-800 mb-3 text-center lg:text-left">
                            Frame Premium Anda
                        </h3>
                        <p class="text-gray-600 mb-2 text-center lg:text-left">Koleksi {{ $photos->count() }} foto
                            terbaik dalam satu frame</p>
                        <p class="text-sm text-gray-500 text-center lg:text-left">Format JPG • Resolusi Tinggi • Siap
                            Cetak 4x6 (2 strip 2x3)</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        {{-- Frame Stats --}}
                        <div class="grid grid-cols-3 gap-2 sm:gap-3 text-center text-xs sm:text-sm">
