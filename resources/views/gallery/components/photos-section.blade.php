        ...
        <div class="p-8">
            ...
            @if($photos->count() > 0)
                          ...
                          <img src="{{ route('photobox.gallery.serve-photo', ['session' => $photoSession->session_code, 'photo' => $photo->id]) }}" 
                            ...
                            <div class="photo-overlay">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button class="w-8 h-8 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center transition-all" 
                ...
                <div class="mt-8 text-center">
                    <div class="flex flex-wrap md:flex-nowrap items-center justify-center gap-4 p-6 bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-sm text-gray-600">Dapatkan semua {{ $photos->count() }} foto dalam satu file ZIP</p>
                            </div>
                            <a href="{{ route('gallery.download.all', $photoSession) }}" class="btn btn-primary ml-0 md:ml-4">
