...
<script>
    ...
    function enterPseudoFullscreen() {
        ...
        // Show notification - DISABLED for client UI
    ...
    async function toggleFullscreen() {
        ...
        try {
            ...
            // Error alert disabled for client UI - just log the error
    ...
    // Auto-fullscreen for tablets (DISABLED for client UI)
    function suggestFullscreenForTablet() {
        // Suggestion disabled - clients don't need to see fullscreen prompts
        return;
