        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="text-center mb-8">
                <button onclick="downloadAllPhotos()" 
                        class="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-lg">
