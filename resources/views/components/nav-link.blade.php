...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-[#1a90d6] text-sm font-medium leading-5 text-slate-900 focus:outline-none focus:border-[#1a90d6] transition duration-150 ease-in-out'
